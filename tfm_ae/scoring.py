...
SCORE_NAME = "calibrated_mae_center_border"
...
def center_border_difference(images: torch.Tensor) -> torch.Tensor:
    ...
    if height < 8 or width < 8:
        raise ValueError("Las imagenes deben medir al menos 8 x 8 pixeles")
...
def anomaly_components(model: ConvAutoencoder, images: torch.Tensor) -> AnomalyComponents:
