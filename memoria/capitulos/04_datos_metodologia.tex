...
Para evitar descomprimir los PNG originales en cada ejecución se generó una
caché \texttt{uint8} del redimensionado. Se comprobó igualdad exacta de píxeles,
etiquetas y rutas en una muestra estratificada, y un benchmark produjo métricas
idénticas reduciendo 13,23 a 2,32 segundos. La caché es regenerable y no añade
transformaciones al protocolo.
