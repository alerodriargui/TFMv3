...
\usepackage{amsmath,amssymb,booktabs,graphicx,hyperref,xcolor,float,csquotes}
...
\hypersetup{
  ...
  pdftitle={Detección de anomalías en radiografías de tórax mediante autoencoders},
...
\begin{titlepage}
  ...
  \vspace{0.8cm}
  {\LARGE\bfseries Detección de anomalías en radiografías de tórax\\
  mediante autoencoders\par}
  \vspace{0.5cm}
  {\large Comparación de AE, VAE y GANomaly con una referencia supervisada\par}
  \vfill
  \begin{tabular}{rl}
...
normales y 1.420 anómalas; test, 781 normales y 16.413 anómalas. La copia local
empleada contiene PNG legibles, monocromos y de 1024$\times$1024. El fuerte
desequilibrio hace inadecuada la exactitud simple.
...
El repositorio contiene rutas configurables, dependencias fijadas, semillas
deterministas, guardado de checkpoints, puntuaciones CSV y configuración JSON.
Las imágenes y los artefactos intermedios se excluyen de Git; se conserva un
único checkpoint congelado para la demostración. El informe distingue mediante el
...
La verificación local encuentra 8.000/1.490/17.194 imágenes en
entrenamiento/validación/test, coincidiendo con BMAD. La campaña completa leyó
las 26.684 radiografías y una ejecución de humo comprobó carga de datos, salida
de los cuatro modelos, métricas y selección del umbral.
...
Para hacer tangible el resultado se entrega una demostración que recibe una
radiografía, aplica el clasificador congelado de la semilla 42 y muestra
probabilidad, umbral de validación y clase normal/anómala. Esta interfaz no cambia
el experimento y recuerda explícitamente que la salida no es un diagnóstico.
