...
Los documentos actuales describían el experimento anterior de 64×64 y se han
conservado sin modificarlos en `legacy/64x64/docs/`. Deben actualizarse cuando
se disponga de las nuevas métricas.
