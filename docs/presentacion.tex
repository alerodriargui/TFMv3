...
\begin{frame}{Arquitectura del autoencoder final}
  \centering
  \includegraphics[width=\textwidth]{assets/autoencoder_architecture.pdf}
  \vspace{-0.15cm}

  \small Tres convoluciones comprimen la imagen y tres convoluciones
  transpuestas recuperan su resolución.
\end{frame}
...
\begin{frame}{Demostración y reproducibilidad}
  \begin{block}{Entrenamiento completo}
    \texttt{python -m tfm\_ae.train}
  \end{block}
  \begin{block}{Una radiografía}
    \texttt{python -m tfm\_ae.demo ruta/a/imagen.png}
  \end{block}
